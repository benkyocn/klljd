  ...
  return new Promise(resolve => {
    ...
    const options = {
      ...
      headers: {
        ...
        "User-Agent": $.isNode() ? (process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : (require('./USER_AGENTS').USER_AGENT)) : ($.getdata('JDUA') ? $.getdata('JDUA') : "jdapp;iPhone;10.0.0;14.6;a1bb1dda60317e3d6f53ce1ea862574f341b38c5;network/wifi;model/iPhone9,2;addressid/4287932682;appBuild/167675;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1"),
      }
    }
